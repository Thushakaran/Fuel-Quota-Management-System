...
//           <p className="lead">Effortlessly manage your fuel quota with ease.</p>
...
//                 <h3 className="h5">Vehicle Registration</h3>
//                 <p>Register your vehicle online and get a unique QR code.</p>
//               </div>
//             </div>
//             <div className="col-md-4">
//               <div className="feature-card p-4 border rounded shadow-sm">
//                 <i className="bi bi-speedometer text-success display-4 mb-3"></i>
//                 <h3 className="h5">Fuel Quota Tracking</h3>
//                 <p>Track your fuel quota in real-time.</p>
//               </div>
//             </div>
//             <div className="col-md-4">
//               <div className="feature-card p-4 border rounded shadow-sm">
...
//                 <p>Receive updates about your fuel usage via SMS or email.</p>
//               </div>
//             </div>
//           </div>
//         </section>
